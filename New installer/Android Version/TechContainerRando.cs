...
public partial class TechContainerRando : PanelContainer
{
	...
	void SetUpButtons()
	{
		...
		allCheckboxes = [Damage, MP, TypeDamage, Accuracy, Status, StatusChance, Finishers, BoostTech, BoostPower, BoostStatus, LearnBattle, LearnBrains, GivenTechs];
		...
		for (int i = 0; i < infoButtons.Length; i++)
		{
			...
			{
				baseScript.OpenInfoWindowTech(allCheckboxes[cat].TooltipText, ReturnLabelTitle(cat) + ":" + "\n" + allCheckboxes[cat].Text);
			};
		}
	}
	...
	{
		Damage.ButtonPressed = false;
		MP.ButtonPressed = false;
		TypeDamage.ButtonPressed = false;
		Accuracy.ButtonPressed = false;
		Status.ButtonPressed = false;
		StatusChance.ButtonPressed = false;
		Finishers.ButtonPressed = false;
		BoostTech.ButtonPressed = false;
		BoostPower.ButtonPressed = false;
		LearnBattle.ButtonPressed = false;
		LearnBrains.ButtonPressed = false;
		GivenTechs.ButtonPressed = false;
		BoostStatus.ButtonPressed = false;
		DamageOpt.Selected = 0;
		MPOpt.Selected = 0;
		TypeDamageOpt.Selected = 0;
		AccuracyOpt.Selected = 0;
		StatusOpt.Selected = 0;
		StatusChanceOpt.Selected = 0;
		FinishersOpt.Selected = 0;
		BoostPowerOpt.Selected = 0;
		LearnBattleOpt.Selected = 0;
		LearnBrainsOpt.Selected = 0;		
	}
