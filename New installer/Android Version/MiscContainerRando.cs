...
public partial class MiscContainerRando : PanelContainer
{
	...
	void SetUpButtons()
	{
		...
		allCheckboxes = [Restaurant, Birdramon, Boost, Healing, Devil, Chips, Seadramon, Fish, TournamentSchedule, Food, RareSpawns, ChaosItems];
		...
		for (int i = 0; i < infoButtons.Length; i++)
		{
			...
			{
				baseScript.OpenInfoWindowMisc(allCheckboxes[cat].TooltipText, Title.Text + ":" + "\n" + allCheckboxes[cat].Text);
			};
		}
	}
	...
	public void RestartData()
	{
		...
		Birdramon.ButtonPressed = false;
		Boost.ButtonPressed = false;
		Healing.ButtonPressed = false;
		Devil.ButtonPressed = false;
		Chips.ButtonPressed = false;
		Seadramon.ButtonPressed = false;
		Fish.ButtonPressed = false;
		TournamentSchedule.ButtonPressed = false;
		Food.ButtonPressed = false;
		RareSpawns.ButtonPressed = false;
		ChaosItems.ButtonPressed = false;
		RestaurantOpt.Selected = 0;
		BirdramonOpt.Selected = 0;
		BoostOpt.Selected = 0;
		HealingOpt.Selected = 0;
		DevilOpt.Selected = 0;
		ChipsOpt.Selected = 0;
		FishOpt.Selected = 0;
		TournamentScheduleOpt.Selected = 0;
		FoodOpt.Selected = 0;
		RareSpawnsOpt.Selected = 0;
	}
