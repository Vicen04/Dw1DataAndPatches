...
public partial class TechContainer : PanelContainer
{
	...
	void AddCrits_Toggled(bool toggled) { VicePatcher.SetCrits(toggled); }
	...
	bool NerfTechS, bool RemoveTechS, bool removeNewEffect, bool nerfEffect, bool removeEffect, bool poisonTimer, bool addEffects, bool addCrits)
	{
		...
		AddCrits.ButtonPressed = addCrits;
	}
