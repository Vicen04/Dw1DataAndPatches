...
public partial class DigimonContainerRando : PanelContainer
{
	...
	{
		DifficultyL.Text = Tr("Difficulty_T");
	...
	void SetUpButtons()
	{
		...
		allCheckboxes = [Difficulty, Digimon, NPCStats, NPCTechs, NPCMoney, Bosses, Starter, StarterTech, StarterLevel, StarterStats, TournamentsNPC, Recruitments];
		...
		for (int i = 0; i < infoButtons.Length; i++)
		{
			...
			{
				baseScript.OpenInfoWindowDigimon(allCheckboxes[cat].TooltipText, ReturnLabelTitle(cat) + ":" + "\n" + allCheckboxes[cat].Text);
			};
		}
	}
	...
	public void RestartData()
	{
		...
		NPCStats.ButtonPressed = false;
		NPCTechs.ButtonPressed = false;
		NPCMoney.ButtonPressed = false;
		Bosses.ButtonPressed = false;
		Starter.ButtonPressed = false;
		StarterTech.ButtonPressed = false;
		StarterLevel.ButtonPressed = false;
		StarterStats.ButtonPressed = false;
		TournamentsNPC.ButtonPressed = false;
		Recruitments.ButtonPressed = false;
		DifficultyOpt.Selected = 0;
		DigimonOpt.Selected = 0;
		NPCStatsOpt.Selected = 0;
		NPCMoneyOpt.Selected = 0;
		StarterTechOpt.Selected = 0;
		StarterLevelOpt.Selected = 2;
		StarterStatsOpt.Selected = 0;
		TournamentsNPCOpt.Selected = 0;
		RecruitmentsOpt.Selected = 0;		
	}
	...
	string ReturnLabelTitle(int value)
	{
		...
		{
			case 0:
			return DifficultyL.Text;
			case 1:			
			case 2:
			case 3:
			case 4:
			case 5:
			return DigimonNPC.Text;
			case 6:
			case 7:
			case 8:
			case 9:
			return StarterDigimon.Text;
			default:
			return OtherPatches.Text;
