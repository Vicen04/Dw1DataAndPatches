...
public partial class EvolutionContainer : PanelContainer
{
	...
	void SetUpButtons()
	{
		...
		allCheckboxes = [Path, Time, StatGains, Requirements, Items, SpeEvolution, SpeChance, SpeRequirements, Factorial, Sukamon];
		...
		for (int i = 0; i < infoButtons.Length; i++)
		{
			...
			{
				baseScript.OpenInfoWindowEvo(allCheckboxes[cat].TooltipText, ReturnLabelTitle(cat) + ":" + "\n" + allCheckboxes[cat].Text);
			};
		}
	}
	...
	{
		Path.ButtonPressed = false;
		Time.ButtonPressed = false;
		StatGains.ButtonPressed = false;
		Requirements.ButtonPressed = false;
		Items.ButtonPressed = false;
		SpeEvolution.ButtonPressed = false;
		SpeChance.ButtonPressed = false;
		SpeRequirements.ButtonPressed = false;
		Factorial.ButtonPressed = false;
		Sukamon.ButtonPressed = false;
		PathOpt.Selected = 0;
		TimeOpt.Selected = 0;
		StatGainsOpt.Selected = 0;
		RequirementsOpt.Selected = 0;
		ItemsOpt.Selected = 0;
		SpeEvolutionOpt.Selected = 0;
		SpeChanceOpt.Selected = 0;
		SpeRequirementsOpt.Selected = 0;
		FactorialOpt.Selected = 0;	
	}
