...
public partial class Recruits : Control
{
	...
	uint[] offsets = { 0x13FDE354, 0x13FDEB8C, 0x13FDF54E, 0x13FE08F2, 0x13FE1D48, 0x13FE4B16, 0x13FE6B52, 0x13FE88E0, 0x13FE909A, 0x13FEB63C, 0x13FED052, 0x13FF1972,
					   ...
					   0x14020E84, 0x14029508, 0x1402A742, 0x1402BAA2, 0x140304F2, 0x14032EE4, 0x140360A2, 0x140396B0, 0x1403AAF6, 0x1403CE84, 0x14040D64, 0x140450AE, 
					   0x14047768, 0x1404CF3E, 0x1404FAD8, 0x14052A7A, 0x1405779C, 0x1405B8C8, 0x14074630, 0x1407750A, 0x1407B9AE, 0x1407C320, 0x14081CC4, 0x14096844},
	prosperity = {0x13FDE359, 0x13FDEB91, 0x13FDF553, 0x13FE08F7, 0x13FE1D4D, 0x13FE4B1B, 0x13FE6B57, 0x13FE88E5, 0x13FE909F, 0x13FEB641, 0x13FED04F, 0x13FF1977,
				  ...
				  0x14020E89, 0x1402950D, 0x1402A747, 0x1402BAA7, 0x140304F7, 0x14032EE9, 0x140360A7, 0x140396B5, 0x1403AAFB, 0x1403CE8D, 0x14040D69, 0x140450B3, 
				  0x1404776D, 0x1404CF43, 0x1404FADD, 0x14052A7F, 0x140577A1, 0x1405B8CD, 0x14074635, 0x1407750F, 0x1407B9B3, 0x1407C325, 0x14081CC9, 0x14096849 };
	int[] recruits = {32, 46, 42, 49, 10, 58, 55, 25, 4, 36, 13, 34, 9, 38, 37, 53, 47, 26, 18, 31, 45, 48, 8, 22, 20, 19, 51, 3, 53, 50, 17, 35, 21, 52, 23, 24, 14,
	...
	public void SetupData(System.IO.Stream bin, System.IO.BinaryReader reader, DataCheck parent, bool vice)
	{
		...
		for (int i = 0; i < offsets.Length; i++)
		{
			...
			list.GetChild(i).AddSibling(allRecruits[i]);
		}
