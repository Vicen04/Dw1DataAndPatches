...
Disassembly:
        ...
        800a2aa0 00 00 43 8e     lw         v1,0x0(s2) //DigimonID
        800a2aa4 42 00 61 28     slti       at,v1,0x42
        800a2aa8 04 00 20 14     bne        at,zero,0x800a2abc //LAB_800a2abc 
        800a2aac 00 00 00 00     _nop
        800a2ab0 64 00 c6 24     addiu      a2,a2,0x64
        800a2ab4 0d 00 00 10     b          0x800a2aec //LAB_800a2aec
        800a2ab8 00 00 00 00     _nop
                             LAB_800a2abc                                    
