RenderTechBrainsLearnText 
{
  ...
  renderSpriteFromVRAM(0, -0x4e, 36, 96, 0, 0, 132, 4, 0); //twice the original width to render everything, render in the next line

//removed one of the function calls since it was no necessary anymore
}
...
Disassembly:
        ...
        8008a9fc 28 00 bf af     sw         ra,local_8(sp)
        8008aa00 0c 00 02 24     li         v0,0xc
        8008aa04 10 00 a2 af     sw         v0,local_20(sp)
        8008aa08 14 00 a0 af     sw         zero,local_1c(sp)
        8008aa0c 78 00 02 24     li         v0,0x78
        8008aa10 18 00 a2 af     sw         v0,local_18(sp)
        8008aa14 04 00 02 24     li         v0,0x4
        8008aa18 1c 00 a2 af     sw         v0,local_14(sp)
        8008aa1c 20 00 a0 af     sw         zero,local_10(sp)
        ...
        8008aa54 21 10 00 00     clear      v0
        8008aa58 10 00 a2 af     sw         v0,local_20(sp)
        8008aa5c 14 00 a2 af     sw         v0,local_1c(sp)
        8008aa60 84 00 02 24     li         v0,0x84
        8008aa64 18 00 a2 af     sw         v0,local_18(sp)
        8008aa68 04 00 02 24     li         v0,0x4
        8008aa6c 1c 00 a2 af     sw         v0,local_14(sp)
        8008aa70 20 00 a0 af     sw         zero,local_10(sp)
        ...
        8008aa88 28 00 bf 8f     lw         ra,local_8(sp)
